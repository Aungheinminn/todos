...
const CreateRoutinePopup: React.FC<RoutinePopupProps> = ({ name, description, setName, setDescription, dropdownItems, selected, setSelected }) => {
    return(
        <AlertDialogHeader>
            ...
            <SelectComponent selected={selected} setSelected={setSelected} dropdownItems={dropdownItems ?? []} />
        </AlertDialogHeader>
    )
}
...
const CreatePopupComponent:React.FC = () => {
    ...
    return (
        ...
        <AlertDialogContent className="w-[320px] bg-[#334155] rounded-lg">
            ...
            {popupData.type === 'createRoutine' && <CreateRoutinePopup name={name} description={desc} setName={setName} setDescription={setDesc} dropdownItems={popupData.dropdownItems} selected={selected} setSelected={setSelected}/>}
